...
- [x] Manifest V3 with production version `1.0.0`.
...
- [ ] Capture current 1280 × 800 screenshots from version `1.0.0`.
...
- [ ] Upload `dist/browser-monitor-1.0.0.zip` with `manifest.json` at the ZIP root.
